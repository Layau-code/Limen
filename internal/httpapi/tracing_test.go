...
func TestGovernedFallbackTraceFormsPrivacySafeEvidenceChain(t *testing.T) {
	...
	registry, err := gateway.NewModelRegistry([]gateway.Model{{ID: "private-model", Targets: []gateway.Target{
		{ID: "openai:secret-upstream-primary", Provider: "openai", UpstreamModel: "secret-upstream-primary", QualityTier: 2, Pricing: &cost.Pricing{InputPerMillionNanoUSD: 1, OutputPerMillionNanoUSD: 1}},
